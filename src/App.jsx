...
class PageWrap extends Component {
    constructor(props) {
        ...
        this.maybeUpdateGlobalSettings = this.maybeUpdateGlobalSettings.bind(
            this
        );
    ...
    isSignPage(check) {
        ...
        return (
            check === "/sign-in" ||
            check === "/sign-up" ||
            check === "/forget-password-email-form" ||
            check.split("?")[0] === "/password-reset-form"
        );
    }
    ...
    maybeCheckAuth(prevProps) {
        ...
        const referrerUrl =
            auth.referrer && !this.isSignPage(auth.referrer)
                ? auth.referrer
                : "/";
    ...
    maybeUpdateGlobalSettings(prevProps) {
        ...
        if (
            prevProps &&
            prevProps.settings.night_mode !== settings.night_mode
        ) {
        ...
        if (
            prevProps &&
            prevProps.settings.show_section_lines !==
                settings.show_section_lines
        ) {
